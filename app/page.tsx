...
export default async function Home() {
  ...
  // ✅ ana sayfada 3 yerine daha dolu dursun
  ...
  return (
    <main className="min-h-screen bg-neutral-50 text-neutral-900">
        ...
        <div className="grid gap-10 md:grid-cols-12 md:items-end">
          <div className="md:col-span-7">
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-neutral-700">
              İzmir ve çevresinde; arsa, villa ve konut portföylerini tek bir yerde.
              Net bilgi, güçlü sunum, hızlı iletişim.
            </p>

            {/* ✅ Ana sayfaya arama + hızlı filtre */}
            <div className="mt-8 rounded-3xl border border-neutral-200 bg-white p-4 shadow-sm">
              <form action="/portfoy" className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <input
                  name="q"
                ...
                />
                <button className="rounded-full bg-neutral-900 px-6 py-4 text-sm text-neutral-50 hover:bg-neutral-800">
                  Ara
                </button>
              </form>
              ...
              <div className="mt-4 flex flex-wrap items-center gap-2">
                ...
                <Link
                  href="/portfoy?cat=Villa"
                  className="rounded-full border border-neutral-300 bg-white px-4 py-2 text-sm hover:border-neutral-400"
                >
                  Villa
                </Link>
                <Link
                  href="/portfoy?cat=Daire"
                  className="rounded-full border border-neutral-300 bg-white px-4 py-2 text-sm hover:border-neutral-400"
                >
                  Daire
                </Link>
                <Link
                  href="/portfoy?cat=Arsa"
                  className="rounded-full border border-neutral-300 bg-white px-4 py-2 text-sm hover:border-neutral-400"
                >
                  Arsa
                </Link>
            ...
            <div className="mt-4 text-sm text-neutral-600">
              Toplam <span className="text-neutral-900 font-medium">{listings.length}</span> portföy
            </div>
          </div>
      ...
      {/* Seçili Portföyler (6 adet) */}
      <section className="mx-auto max-w-6xl px-6 pt-16">
        <div className="flex items-end justify-between gap-6">
          <div>
            <h2 className="text-2xl font-semibold tracking-tight">Güncel Portföyler</h2>
            <p className="mt-2 text-sm text-neutral-600">
              Admin panelden eklenen ilanlar burada otomatik listelenir.
            </p>
          </div>
      ...
      <section id="hakkimda" className="mx-auto max-w-6xl px-6 pt-20">
        <div className="rounded-3xl border border-neutral-200 bg-white p-8 md:p-12">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-relaxed text-neutral-700">
            Furkan Azak Gayrimenkul olarak amacım; portföyleri doğru fiyat, doğru sunum ve hızlı iletişimle yönetmek.
            Süreci şeffaf yürütür, alıcı ve satıcı tarafında güveni önceliklendiririm.
          </p>
        </div>
      </section>
      ...
      <footer id="iletisim" className="mx-auto mt-20 max-w-6xl border-t border-neutral-200 px-6 py-12">
        ...
        <div className="mt-10 text-xs text-neutral-500">©️ {new Date().getFullYear()} Furkan Azak Gayrimenkul</div>
      </footer>
    </main>
  );
}